...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lunar = __webpack_require__(8);
	...
	var Timeline = function (_mix) {
		_inherits(Timeline, _mix);

		function Timeline() {
			var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'tl';
			...
			_this.name = name;
			_this.dataList = new Set();
			_this.content_el = '#content';
			_this.scrubber_el = '#scrubber';
			_this.scrubberTop = (0, _jquery2.default)(_this.scrubber_el).offset().top - 91;
			_this.updateState();
			_this.initEvent();
			return _this;
		}
		...
		_createClass(Timeline, [{
			...
			value: function initEvent() {
				var self = this;
				(0, _jquery2.default)(self.scrubber_el).on('click', 'a', self.changeTabNav);
				(0, _jquery2.default)(document).on('scroll', self.listenScroll.bind(self));
			}
		}]);

		return Timeline;
	}(mix(_base2.default, _calculate2.default, _interface2.default, _lunar2.default));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Base = function () {
		...
		_createClass(Base, [{
			key: 'getContentListHTML',

			//中间列表HTML
			value: function getContentListHTML() {
				var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

				var self = this,
				    html = '';
				this.dataList = new Set(data);
				var list = this.changeDataToMap(data);
				...
				try {
					for (var _iterator = list.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						try {
							for (var _iterator2 = year.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
								...
								try {
									for (var _iterator3 = month.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
										var _step3$value = _slicedToArray(_step3.value, 2),
										    idx = _step3$value[0],
										    li = _step3$value[1];

										var lunar = self.GetLunarDateString(new Date(li.date));
				...
				(0, _jQuery2.default)(self.content_el).html(html);
			...
			key: 'getscrubberHTML',
			value: function getscrubberHTML(list) {
				var self = this;
				var html = '<a href="javascript:;" class="current" id="top">\u73B0\u5728</a>';
				var _iteratorNormalCompletion4 = true;
				var _didIteratorError4 = false;
				var _iteratorError4 = undefined;

				try {
					for (var _iterator4 = list.entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						...
						try {
							for (var _iterator5 = year.entries()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
								var _step5$value = _slicedToArray(_step5.value, 2),
								    m = _step5$value[0],
								    month = _step5$value[1];
				...
				(0, _jQuery2.default)(self.scrubber_el).html(html);
			}
			...
			key: 'changeDataToMap',
			value: function changeDataToMap() {
				var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
				...
				try {
					for (var _iterator6 = data[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
						...
						var year = li.date.split('/')[0];
						var month = li.date.split('/')[1];
						if (lastyear === year) {
							if (lastmonth === month) {
			...
			key: 'changeTabNav',
			value: function changeTabNav(e) {
				var self = this;
				var id = e.currentTarget.id.replace(/scrubber/, 'content');
				var top = 0;
				if (id === 'top') {
					top = 0;
				} else if (id === 'bottom') {
					top = (0, _jQuery2.default)(document).height() - (0, _jQuery2.default)(window).height();
				} else {
					top = (0, _jQuery2.default)('#' + id).offset().top - 50;
				}
			...
			value: function listenScroll(e) {
				...
				var scruTop = self.scrubberTop;
				var cha = scrollTop - scruTop;
				if (scrollTop < scruTop && (0, _jQuery2.default)(self.scrubber_el).attr('style') != "") {
					(0, _jQuery2.default)(self.scrubber_el).removeAttr("style");
				} else if (scrollTop >= scruTop) {
					(0, _jQuery2.default)(self.scrubber_el).css({ top: cha + "px" });
				}

				var arr = (0, _jQuery2.default)(self.content_el).find(".tips").filter(function (idx, ele) {
					return (0, _jQuery2.default)(ele).offset().top < scrollTop + 100;
				});
				if (arr.length > 0) {
					var id = arr[arr.length - 1].id.replace(/content/, 'scrubber');
					(0, _jQuery2.default)('#' + id).addClass("current").siblings().removeClass("current");
				}
			}
		}]);
...
/***/ (function(module, exports) {
	...
	var Lunar = function () {
	   ...
	   _createClass(Lunar, [{
	      key: "LunarDaysOfMonthArr",
	      value: function LunarDaysOfMonthArr() {
	         return new Array(0xd4a8, 0xd4a0, 0xda50, 0x5aa8, 0x56a0, 0xaad8, 0x25d0, 0x92d0, 0xc958, 0xa950, // 2001-2010 
	      ...
	      key: "LunarLeapYearArr",
	      value: function LunarLeapYearArr() {
	         return new Array(0x40, 0x02, 0x07, 0x00, 0x50, // 2001-2010 
	      ...
	      key: "GetLeapMonth",
	      value: function GetLeapMonth(iLunarYear) {
	         var Leap = this.LunarLeapYearArr([iLunarYear - 2001 >> 1]);
	      ...
	      key: "LunarMonthDays",
	      value: function LunarMonthDays(iLunarYear, iLunarMonth) {
	         ...
	         if (this.LunarDaysOfMonthArr([iLunarYear - 2001] & 1 << Bit) > 0) Low++;

	         if (iLunarMonth == this.GetLeapMonth(iLunarYear)) {

	            High = this.LunarDaysOfMonthArr([iLunarYear - 2001] & 1 << Bit - 1) > 0 ? 30 : 29;
	         }
	      ...
	      key: "LunarYearDays",
	      value: function LunarYearDays(iLunarYear) {
	      ...
	      key: "FormatLunarYear",
	      value: function FormatLunarYear(iLunarYear) {
	      ...
	      key: "FormatLunarMonth",
	      value: function FormatLunarMonth(iLunarMonth) {
	         ...
	         } else if (iLunarMonth == 11) strMonth = "十一";else strMonth = "十二";
	      ...
	      key: "FormatLunarDay",
	      value: function FormatLunarDay(iLunarDay) {
	      ...
	      key: "GetLunarDateString",
	      value: function GetLunarDateString(SolarDate) {
	         ...
	         //return this.FormatLunarYear(iLunarYear) + (Leap ? "闰" : "") + this.FormatLunarMonth(iLunarMonth) + this.FormatLunarDay(iLunarDay);

	         return this.FormatLunarDay(iLunarDay); //只返回日期
	      }
	   }]);
